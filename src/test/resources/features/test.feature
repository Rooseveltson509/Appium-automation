...
#Feature: As a user I want connect to the store
 # @Register
  ...
  #Scenario Outline: Test 2
   ...
   # And I choose products "<product1>" then "<product2>"
   # And I go to my cart
   # And I validate my cart with card number "<cardNumber>" and expiration date "<expirationDate>" and "<CVC>"
    #Then I payed my order
    #Examples:
     # | email           | password   | cardNumber       | expirationDate | CVC | product1 | product2 |
     # | roose@gmail.com | roosetest1 | 4242424242424242 | 1122           | 123 | Wireless | Logitech |